...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/75 backdrop-blur-md dark:border-white/10 dark:bg-[#0f1727]/78">
      ...
      <div className="flex items-center gap-2 overflow-x-auto border-t border-border/50 px-4 py-2.5 text-sm font-semibold text-muted-foreground scrollbar-none sm:px-6 md:hidden">
        <Link
          href={navLinks[0].href}
