...
const exactTranslations: Record<string, string> = {
  ...
  "결제 확인 후 관리자가 URL에서 심의 자료를 준비합니다. URL 접수 추가금은 0원입니다.": "Once payment is confirmed, our staff will prepare review materials from your URL. There is no extra charge for URL submission.",
  ...
  "URL 입력 → 관리자 자료 준비 → 심의 진행": "Enter URL → Staff Prepare Materials → Review",
  ...
  "앨범 URL을 보내주시면 관리자가 앨범·트랙 정보를 확인하고 심의 자료를 준비합니다. 별도의 신청서 작성이나 음원 파일 첨부 없이 접수할 수 있어요.": "Submit your album URL and our staff will check the album and track details and prepare the review materials. No separate application form or audio upload is needed.",
  ...
  "멜론 또는 지니의 앨범 링크를 준비해주세요. 신청서 작성과 음원 파일 첨부 없이 접수할 수 있어요.": "Prepare your Melon or Genie album link. No application form or audio upload is needed.",
  "추가금 없이 이용하며, 접수한 링크로 관리자가 심의 자료를 준비합니다.": "There is no extra charge. Our staff will use your link to prepare the review materials.",
  ...
  "발매 후: 신청서 작성과 음원 첨부 없이 관리자가 자료 준비": "Released: staff prepare materials without an application form or audio upload",
  "발매된 음반은 멜론·지니 링크로 추가금 없이 접수": "Released albums can be submitted by Melon or Genie link at no extra charge",
  "가능합니다. 음반 심의 접수에서 이미 발매된 음반을 선택하고 멜론 또는 지니의 앨범 링크를 입력해주세요. 추가금과 신청서 작성, 음원 파일 첨부 없이 접수하며 관리자가 심의 자료를 준비합니다.": "Yes. Choose Already Released in the album review submission and enter a Melon or Genie album link. There is no extra charge, application form, or audio upload; our staff will prepare the review materials.",
