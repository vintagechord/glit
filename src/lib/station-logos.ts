...
export const stationLogoSources: StationLogoSource[] = [
  ...
  { patterns: ["TBS", "TBS EFM", "교통방송"], src: "/station-logos/tbs.webp", alt: "TBS" },
  ...
  { patterns: ["PBC", "평화방송"], src: "/station-logos/pbc.svg", alt: "PBC 평화방송" },
  ...
  { patterns: ["TBN", "한국도로교통공단", "도로교통공단", "교통방송"], src: "/station-logos/tbn.webp", alt: "TBN" },
  { patterns: ["KISS"], src: "/station-logos/kiss.webp", alt: "KISS" },
