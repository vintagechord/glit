export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "가능합니다. 음반 심의 접수에서 이미 발매된 음반을 선택하고 멜론 또는 지니의 앨범 링크를 입력해주세요. 추가금과 별도의 신청서 작성은 필요 없으며, 심의용 음원 파일(WAV 또는 ZIP)은 사이트에 직접 첨부해주세요. 관리자가 앨범 정보와 첨부한 음원으로 심의 자료를 준비합니다.",
  },
  {
    category: "결제",
...
export const albumPreparationItems = [
  "공통: 접수자 이름, 이메일, 연락처",
  "발매 전: 신청서와 WAV 음원 또는 전체 음원 ZIP",
  "발매 전: 앨범 정보, 트랙별 크레딧, 전체 가사와 외국어 번역",
  "발매 후: 멜론 또는 지니 앨범 링크로 추가금 없이 접수",
  "발매 후: 신청서는 앨범 링크로 대신하고 WAV 음원 또는 전체 음원 ZIP 첨부",
];
