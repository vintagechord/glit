...
현재 포함된 파일은 자동 생성 ZIP이 즉시 동작하도록 만든 기본 템플릿입니다.
방송사 공식 양식이 확정되면 같은 파일명으로 교체하면 됩니다.
...
기본 템플릿을 다시 생성해야 할 때는 아래 명령을 실행합니다.

```sh
node scripts/generate-review-doc-templates.mjs
```
